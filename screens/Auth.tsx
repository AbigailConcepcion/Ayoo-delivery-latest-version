...
const Auth: React.FC<AuthProps> = ({ onLogin }) => {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const body = isLogin 
        ...
        : { email: email.trim(), password, name: name.trim(), role, restaurantName: restaurantName.trim() };
  ...
  return (
    <motion.div 
      ...
      animate={{ backgroundColor: isLogin ? '#FF00CC' : '#FFFFFF' }}
      ...
      <AnimatePresence mode="wait">
        {!isLogin ? (
          ...
          <motion.div 
            ...
            className="flex-1 flex flex-col p-8 pt-12 overflow-y-auto bg-white"
          >
          ...
          >
            <div className="flex-[0.4] flex flex-col items-center justify-center p-8">
              <motion.div
            ...
            <motion.div 
              ...
              animate={{ y: 0 }}
              transition={{ type: "spring", stiffness: 300, damping: 30 }}
              className="flex-[0.6] bg-white rounded-t-[40px] p-8 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] flex flex-col"
            >
      ...
      <AnimatePresence>
        {showSuccess && (
          <motion.div 
            ...
            className="fixed bottom-24 left-1/2 -translate-x-1/2 w-[92%] z-50"
          >
